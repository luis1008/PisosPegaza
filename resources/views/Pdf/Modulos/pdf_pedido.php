...
<body>
	...
	<div class="info">
		...
		<p>Av. Enrique Corona Morfin #93, Villa de Alvarez, Col.</p>
		<p><b>Tels:</b> 312-115-7493, 396-4278</p>
	...
	<div style="border:2px solid black;margin-top:15px;padding:5px;font-size:10px;text-align:justify;">
		<div>
			<p style="display:inline-block;">EN VILLA DE ALVAREZ, COLIMA A ______ DE _______ DE ________ 
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	...
	<?php if($nota == "ORIGINAL"){ $nota = "COPIA"; ?>
