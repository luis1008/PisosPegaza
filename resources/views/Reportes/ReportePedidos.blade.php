...
@section('body')
    <form action="{{route('get_pedido_entregado')}}" method="GET">
        <div class="form-row">
    ...
    <div class="card text-black bg-light">
        <div class="card-header text-center text-white bg-danger"><b>PEDIDOS ENTREGADOS</b></div>
